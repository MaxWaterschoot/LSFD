...
namespace LSFD.MainClasses
{
    public class Checkpoint : IDeletable, ISpatial
    {
        ...
        private void CreateCheckpoint()
        {
            ...
            {
                float groundZ = 0f;
                NativeFunction.CallByName<bool>("GET_GROUND_Z_FOR_3D_COORD", place_position.X, place_position.Y, place_position.Z, groundZ, 0);
                place_position = new Vector3(Position.X, Position.Y, groundZ);
            }
